...
function love.load()
    ...
    gStateMachine = StateMachine {
        ['start'] = function() return StartState(highscores) end,
        ['play'] = function() return PlayState(highscores) end,
        ['game-over'] = function() return GameOverState() end,
        ['high-scores'] = function() return HighScoreState(highscores) end,
        ['enter-high-score'] = function() return EnterHighScoreState(highscores) end
    }
...
-- https://github.com/GameLoop-it/cs50_course_materials/blob/master/assignment4/karbb/src/LevelMaker.lua